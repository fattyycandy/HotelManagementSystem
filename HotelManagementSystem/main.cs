...
namespace HotelManagementSystem
{
    public partial class main : Form
    {
        ...
        {
            InitializeComponent();
            string con = "Data Source=.\\SQLEXPRESS;AttachDbFilename=|DataDirectory|\\hotel.mdf;User ID=sa;Password=44181744";
            string sql = "select Bname,Bkey from [user]";
        ...
        {
            string con = "Data Source=.\\SQLEXPRESS;AttachDbFilename=|DataDirectory|\\hotel.mdf;User ID=sa;Password=44181744";
            string sql = "select Gname,Sintime,Gno,Msum,GID from [order] where Sintime='" + dateTimePicker1.Text.ToString() + "'";
            SqlConnection mycon = new SqlConnection(con);
            SqlCommand cmd = new SqlCommand(sql, mycon);
            if (mycon.State == ConnectionState.Closed)
                mycon.Open();
        ...
        {
            string con = "Data Source=.\\SQLEXPRESS;AttachDbFilename=|DataDirectory|\\hotel.mdf;User ID=sa;Password=44181744";
            string sql = "select Gname,Sintime,Gno,Msum,GID from [order] where Gname='" + textBox5.Text + "'";
            SqlConnection mycon = new SqlConnection(con);
            SqlCommand cmd = new SqlCommand(sql, mycon);
            if (mycon.State == ConnectionState.Closed)
                mycon.Open();
